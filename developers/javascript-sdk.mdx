...
Complete examples are available in the [screenpipe GitHub repository](https://github.com/screenpipe/screenpipe/tree/main/packages/screenpipe-js/examples):

- [Basic Query](https://github.com/screenpipe/screenpipe/tree/main/packages/screenpipe-js/examples/query-screenpipe)
- [Real-time Transcription](https://github.com/screenpipe/screenpipe/tree/main/packages/screenpipe-js/examples/basic-transcription)
- [Screenshot Streaming](https://github.com/screenpipe/screenpipe/tree/main/packages/screenpipe-js/examples/stream-screenshots)
